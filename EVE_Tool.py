...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget_resell = QtWidgets.QTreeWidget(self.groupBox_tree)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeWidget_resell.sizePolicy().hasHeightForWidth())
        self.treeWidget_resell.setSizePolicy(sizePolicy)
        self.treeWidget_resell.setMinimumSize(QtCore.QSize(0, 0))
        self.treeWidget_resell.setObjectName("treeWidget_resell")
        item_0 = QtWidgets.QTreeWidgetItem(self.treeWidget_resell)
        item_0.setCheckState(0, QtCore.Qt.Checked)
        item_0 = QtWidgets.QTreeWidgetItem(self.treeWidget_resell)
        item_0.setCheckState(0, QtCore.Qt.Checked)
        self.verticalLayout_5.addWidget(self.treeWidget_resell)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget_resell.headerItem().setText(0, _translate("MainWindow", "root"))
        __sortingEnabled = self.treeWidget_resell.isSortingEnabled()
        self.treeWidget_resell.setSortingEnabled(False)
        self.treeWidget_resell.topLevelItem(0).setText(0, _translate("MainWindow", "1"))
        self.treeWidget_resell.topLevelItem(1).setText(0, _translate("MainWindow", "2"))
        self.treeWidget_resell.setSortingEnabled(__sortingEnabled)
